...
64. **骑士 SHERIFF_SPEECH/SHERIFF_RUN 评估**：骑士目前走好人 fallback（与摄梦人/魔术师修复前状态相同），骑士有"决斗威慑"竞选价值，值得补专属分支
65. **SHERIFF_SPEECH 全角色覆盖常驻检查**：每轮结束后对比游戏中存在的角色列表，确认 SHERIFF_SPEECH 均有专属分支或有意选择好人 fallback
