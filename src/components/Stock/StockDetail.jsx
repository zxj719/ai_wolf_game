...
/**
 * StockDetail - 个股详情页
 * @param {{ symbol: string, name: string, market: string, onBack: () => void }} props
 */
export function StockDetail({ symbol, name, market = 'stock', onBack }) {
  const [tab, setTab] = useState('timeline'); // 'timeline' | 'kline'
