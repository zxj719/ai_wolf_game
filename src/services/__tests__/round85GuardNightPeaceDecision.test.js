...
function getNightGuardBlock() {
    ...
    // NIGHT_GUARD case R85 后约 4650 chars，R94 后约 5810 chars，R97 后约 7761 chars，用 8500 留余量
...
test('T19: NIGHT_GUARD block 总大小 < 8500 chars（窗口安全验证，R97 后约 7761 chars）', () => {
    const start = src.indexOf('case PROMPT_ACTIONS.NIGHT_GUARD: {');
    const end = src.indexOf('case PROMPT_ACTIONS.NIGHT_MAGICIAN:', start);
    const blockSize = end - start;
    // R97 后约 7761 chars，确保 8500 窗口足够
